...
include "../koneksi/koneksi.php";
 ...
 if (isset($_SESSION['NamaUser'])){
    echo "<script>alert('maaf ada sudah login,silakan logout terlebih dahulu');window.location.replace('index.php')</script>";
 }
            ...
            <div class="col-md-4">
                <div class="card" style="background-color:lightblue">
                    <div class="card-header" style="background-color:turquoise">
                        <h3 class="text-center" style="color:coral"><lebel>LOGIN<Login</h3>
                    </div>
                    <div class="card-body">
